...
### Objective
Design and configure a multi-department network for a small company. Separate the Admin and Staff departments with VLANs, assign a static IP address to Admin devices, and use DHCP for Staff devices. Enable communication between both departments using Router-on-a-Stick.
