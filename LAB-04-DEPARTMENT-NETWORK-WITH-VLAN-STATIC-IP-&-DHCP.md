...
### Objective
Design and configure a multi-department network for a small company. Separate the Admin and Staff departments using VLANs, apply Static IP addressing for Admin devices, and use DHCP for Staff devices. Enable communication between both departments using Router-on-a-Stick.
